...
--
-- Table structure for table `click_info`
--
...
CREATE TABLE `click_info` (
  ...
  `click_link` varchar(200) DEFAULT NULL,
  `reg_date` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `click_info`
--

LOCK TABLES `click_info` WRITE;
/*!40000 ALTER TABLE `click_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `click_info` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-09-10  0:48:10
